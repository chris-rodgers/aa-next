    ...
    return <React.Fragment>
        ...
        <div className={`${styles.header} ${styles['header--filters']}`}>
            ...
            <div className={styles.header__row}>
                ...
                <button className={styles.header__item} onClick={handleSelectModal}><small>▼</small> Class</button>
                <button className={styles.header__item} onClick={handleSelectModal}><small>▼</small> Times</button>
                <button className={styles.header__item} onClick={handleSelectModal}><small>▼</small> Duration</button>
            </div>
        </div>
        <AutoSizer>
            {({ height, width }) => (
